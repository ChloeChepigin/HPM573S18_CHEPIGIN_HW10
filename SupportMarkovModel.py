...
def draw_survival_curves_and_histograms(simOutputs_none, simOutputs_anticoag):
    """
    :param simOutputs_none: output of a cohort simulated with no treatment
    :param simOutputs_anticoag: output of a cohort simulated with anticoagulation
    :return:
    """
    ...
    PathCls.graph_sample_paths(
        ...
        legends=['No Therapy', 'Anticoag Therapy']
    )
